                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    <button onclick="testConnection('<?php echo e(url('/mikrotik/test-koneksi/' . $router->id)); ?>')" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">
                                        <i class="mgc_link_line"></i>
                                    </button>
                                    <a href="<?php echo e(route('mikrotik.edit', $router->id)); ?>" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white">
                                    ...
                                    <button onclick="confirmDelete('delete-form-<?php echo e($router->id); ?>')" class="text-red-500 hover:text-red-700">
